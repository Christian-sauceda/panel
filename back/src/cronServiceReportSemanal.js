                            ...
                            <tr>
                              <td align="center" style="padding:0;">
                                  ...
                                  <tr>
                                    <td style="padding:30px; background-color:#ffffff;">
                                      <h3 style="margin:0; color:black;">Series en Inglés</h3>
                                        ...
                                        ${sumaseriesen.map((totalseren) => `<span style="font-weight: bold;"> TOTAL TVSHOWS: ${totalseren.total_contents} TOTAL CAPITULOS: ${totalseren.total_chapters} </span> `).join("")}
                                    </td>
                                  </tr>
                                  <tr>
                                    <td style="padding:30px; background-color:#ffffff;">
                                      <h3 style="margin:0; color:black;">Series en Español</h3>
                                        ...
                                        ${sumaserieses.map((totalseres) => `<span style="font-weight: bold;"> TOTAL SERIES: ${totalseres.total_contents} TOTAL CAPITULOS: ${totalseres.total_chapters} </span> `).join("")}
                                    </td>
                                  </tr>           
                                  <tr>
                                ...
                                <td style="padding:30px;background-color:#ffffff;">
                                  ...
                                  <ul>
                                  ${listasport.map((eventosdep) => `<li><span style="color: black">${eventosdep.title}</span></li>`).join("")}
                                  </ul>
